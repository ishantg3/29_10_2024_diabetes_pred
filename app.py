...
default_model = pickle.load(open(r'D:\Projects\Sugar_predicition\pickle_files\rfc_model.pkl', 'rb'))
default_scaler = pickle.load(open(r'D:\Projects\Sugar_predicition\pickle_files\scaler.pkl', 'rb'))
